...
import com.rev.pms.utilities.GenerateRandomNumber;
import com.rev.pms.utilities.PasswordHashing;
...
public class ProductController {
    ...
    //If the bean is not available , then don't give me an error
    ...
    public ResponseEntity<String> saveProduct(@RequestBody Product product) {
        ...
        if (productService.isProductExists(product.getProductId())) {
            ...
            if (result) {
                responseEntity = new ResponseEntity<String>
                        ("Successfully Saved your product ID: " + product.getProductId(), HttpStatus.OK);        //200
     ...
     */
    @DeleteMapping("{pId}")     //localhost:8084/product/44                        -HTTP method - DELETE
